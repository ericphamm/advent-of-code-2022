...
for pairs in content:
	...
	if(int(second_elf[0]) >= int(first_elf[0]) and int(second_elf[0]) <= int(first_elf[1])) or (int(second_elf[1]) >= int(first_elf[0]) and int(second_elf[1]) <= int(first_elf[1])) or (int(first_elf[0]) >= int(second_elf[0]) and int(first_elf[0]) <= int(second_elf[1])) or (int(first_elf[1]) >= int(second_elf[0]) and int(first_elf[1]) <= int(second_elf[1])):
		overlapped += 1
